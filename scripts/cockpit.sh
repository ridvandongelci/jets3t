...
CP=$CP:$JETS3T_HOME/jars/jets3t-0.6.1.jar
CP=$CP:$JETS3T_HOME/jars/jets3t-gui-0.6.1.jar
CP=$CP:$JETS3T_HOME/jars/cockpit-0.6.1.jar
...
"$EXEC" -DsocksProxyHost=localhost -DsocksProxyPort=12345 -Xmx128M -classpath "$CP" org.jets3t.apps.cockpit.Cockpit
